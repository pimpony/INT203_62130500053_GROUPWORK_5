...
app.component('photo-item', {
  ...
  template:
    ...
    <div v-if="this.$emit('photoitem') !== 0"class=" ">
        <li v-for="(gallery, index) in photoitem" class="flex flex-col items-center w-full mt-5">
          
          <div class="w-full text-gray-700 font-san flex  w-48 flex justify-between item-center">
          <button @click="this.$emit('zoomphoto', index)"><img :src="gallery.src" class=" w-full rounded-sm"
              :alt="gallery.title"></button>
